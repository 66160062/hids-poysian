        ...
        <div class="q-px-md q-pt-lg">
              ...
              <q-menu anchor="bottom right" self="top right">
                <q-list style="min-width: 160px">
                  <q-item clickable v-close-popup :active="sortOrder === 'desc'" active-class="text-primary" @click="sortOrder = 'desc'">
                    <q-item-section>{{ t('adminManage.notifications.sortNewestFirst') }}</q-item-section>
                  </q-item>
                  <q-item clickable v-close-popup :active="sortOrder === 'asc'" active-class="text-primary" @click="sortOrder = 'asc'">
                    <q-item-section>{{ t('adminManage.notifications.sortOldestFirst') }}</q-item-section>
                  </q-item>
                </q-list>
              </q-menu>
            </q-btn>
          ...
          <div class="notifications-wrapper">
            <div v-if="filteredNotifications.length === 0" class="text-center text-grey-6 q-pa-xl">
              {{ t('adminManage.notifications.noResults') }}
            </div>
                ...
                <q-card-section class="q-pa-md">
                  <div class="row q-gutter-x-sm q-mb-md">
                    ...
                    >
                      ...
                      {{ item.type === 'alert' ? t('adminManage.notifications.typeAlert') : t('adminManage.notifications.typeInfo') }}
                    </q-badge>
                  </div>
                  ...
                  <div class="row justify-between items-start q-mb-sm">
                    ...
                    <q-badge
                      ...
                      class="status-badge"
                    >
                      {{ !item.isRead ? t('adminManage.notifications.statusUnread') : t('adminManage.notifications.statusRead') }}
                    </q-badge>
                  </div>
                </q-card-section>
